...
function check()
{
 ...
 if(document.form1.pass.value=="")
  ...
  {
    alert("Plese Enter Enrollment No");
	document.form1.eno.focus();
	return false;
  }
  if(document.form1.ccode.value=="")
  {
    alert("Plese Enter Course Code");
	document.form1.ccode.focus();
	return false;
  }
  if(document.form1.lid.value=="")
  {
    alert("Plese Enter Roll No");
     ...
     <td><form name="form1" method="post" action="signupuser.php" onSubmit="return check();">
       <table width="301" border="0" align="left">
         <tr>
		   ...
		   &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<img src="image/freeuser.jpg">
         </tr>
         <tr>
		 ...
		 <tr>
           <td class="style7">Enrollment NO.</td>
           <td><input name="eno" type="text" id="eno"></td>
         </tr>
		 <tr>
           <td class="style7">Course Code</td>
