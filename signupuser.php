...
$query="insert into mst_user(user_id,login,pass,username,enrollment,course_code,roll_no,address,city,phone,email) values('$uid','$lid','$pass','$name','$eno','$ccode','$roll','$address','$city','$phone','$email')";
