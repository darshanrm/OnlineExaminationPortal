...
$sr=mysql_query("select enrollment from mst_user where login='$login'",$cn) or die(mysql_error());
...
echo "<table border=1 align=center><tr class=style2><td width=300>Test Name <td> Total<br> Question <td> Score <td> Enrollment no ";
