...
echo  "<b><h3 class='style8' align=left>Welcome &nbsp".$_SESSION['login']."</h3></b>";
$today = date("F j, Y,");
echo $today;
...
<table width="100%" border="0">
  ...
  <tr>
    <td height="296" valign="top"><div align="center">
		...
		<span class="style5"><img src="image/inter.jpg" width="500" height="300">
         </span>
...
<p align="left" class="style5">&nbsp;</p>
    ...
    <td valign="top"><form name="form1" method="post" action="">
      <table width="200" border="0">
        ...
        <tr>
          <td colspan="2" bgcolor="#CC3300"><div align="center"><span class="style4">New User ? &nbsp <a href="signup.php"><font color='yellow'>Signup Free</font></a></span></div></td>
          </tr>
      </table>
      <div align="center">
