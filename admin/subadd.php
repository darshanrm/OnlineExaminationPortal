...
<label ><div align="center">Enter Subject Name</div></label><br>
<div align="center"><input name="subname" placeholder="enter language name" type="text" id="subname"></div><br><br>
